...
train_config=conf/train_conformer_transducer_noam_greedyLA_WarmStart13.yaml # current default recipe requires 4 gpus.
...
expname=${expname}_300bpe_fromLibri100SOTA
