...
#resume=/home/vinit/exp/espnet-0.10.4/egs/librispeech/asr1/exp/train_100_pytorch_train_rnnt_voxforge_specaug/results/snapshot.ep.20        # Resume the training from snapshot
resume=/home/vinit/exp/espnet-0.10.4/egs/librispeech/asr1/exp/train_100_pytorch_train_rnn_transducer_future_context_greedy_aligned_noSamp_layers4_la-ILM_warmstart2_smallEmbed64_specaug_CharVocab_SingleGPU/results/snapshot.ep.5   # Resume the training from snapshot

# feature configuration
do_delta=false

preprocess_config=conf/specaug.yaml
train_config=conf/train_rnn_transducer_future_context_greedy_aligned_noSamp_layers4_la-ILM_warmstart2_smallEmbed64.yaml # current default recipe requires 4 gpus.
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    echo "stage 2: Dictionary and Json Data Preparation using char"
...
expname=${expname}_CharVocab_SingleGPU
expdir=exp/${expname}
mkdir -p ${expdir}
